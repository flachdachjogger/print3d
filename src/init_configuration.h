...
#define _AXIS_STEP_PER_UNIT {29.0909, 29.0909, 29.0909,50}
...
#define _X_ENDSTOP_INVERT 	true
#define _Y_ENDSTOP_INVERT 	true
#define _Z_ENDSTOP_INVERT 	true
...
#define _HOMING_FEEDRATE {5000,5000,5000}      // (mm/min) !!
...
//Calibration offsets
#define DELTA_OFFSET_X 0
#define DELTA_OFFSET_Y 0
#define DELTA_OFFSET_Z 0
